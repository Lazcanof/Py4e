...
# and retrieve the first place_id from the JSON. A place ID is a textual identifier that uniquely
...
# that you are requesting as the address= parameter that is properly URL encoded using 
